 ...
 */
export const fetchUrlLang = (): string => new URLSearchParams(window.location.search).get('language') || 'All'
 ...
 */
export const fetchRequestUrl = (lang: string = 'All', current: number = 1, limit: number = 10): string => {
